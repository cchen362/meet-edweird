...
**Status: Approved 2026-09-09. M1, M2, M4, M3 complete (M4 was pulled ahead of M3 on 2026-09-09 because the Codex endpoint stopped serving `gpt-5.4` and chat was silently falling back to the metered API key). M5 next.**
